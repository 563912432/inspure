<template>
  <div class="menu">
    ...
    <div class="bg-white box-shadow">
      ...
      <pagination v-show="total>0" class="text-center" :total="total" :page.sync="pageQuery.page" :limit.sync="pageQuery.page_size" @pagination="getListMenu" />
    </div>
...
<script>
import { fetchListMenu, handleMenuAdd, handleMenuDel } from '@/api/auth'
